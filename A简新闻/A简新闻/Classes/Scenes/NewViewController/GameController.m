...
//    if (time > 2 * 60) {
        [[NSNotificationCenter defaultCenter] postNotificationName:@"top5" object:nil userInfo:@{@"name":@"游戏",@"time":[NSNumber numberWithDouble:time]}];
//    };
...
- (void)dataPatsEvent{
    ...
    NSString * url = [NSString stringWithFormat:@"%@%d-%d.html",kGame,0,self.urlNumber];
